...
function Login() {
  ...
  return (
    <div className="mx-auto max-w-screen-xl md:min-w-[768px] min-w-fit min-[480px]:min-w-[360px] px-4 py-16 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              <input
                type="email"
                className="w-full rounded-lg appearance-none border-gray-200 p-4 pr-12 text-sm shadow-sm focus:border-white focus:outline-none focus:ring-linkedout focus:ring-1"
