          ...
          <form action="#" class="sm:flex sm:gap-4">
            <div class="sm:flex-1">
              ...
              <input
                ...
                class="w-full rounded-md border-gray-200 bg-white p-3 text-gray-700 shadow-sm transition focus:border-white focus:outline-none focus:ring focus:ring-linkedout"
              />
            </div>
