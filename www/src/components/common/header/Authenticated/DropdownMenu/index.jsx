...
function DropdownMenu() {
  ...
  return (
    <div className="select-none">
      <div class="group">
        <div class="inline-flex cursor-pointer items-center justify-between rounded-t-lg py-2 px-4 text-gray-500 group-hover:bg-gray-100 group-hover:text-gray-700">
        ...
        <div class="hidden group-hover:absolute w-[12.35rem] group-hover:flex z-10 flex-1 bg-gray-100 rounded-b-lg flex-col p-2">
          <div
